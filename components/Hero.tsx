        ...
        <div className="col-span-1 lg:col-span-6 h-full text-offWhite flex flex-col justify-center order-2 lg:order-1  ">
          ...
          >
            ...
            <p className="font-normal md:font-medium text-base md:text-lg max-w-2xl h-[180px] md:h-[130px]">
              <Typewriter
                words={[
                  "Hello, I'm Prophet Bestman, an experienced React.js frontend developer with a strong skill set in HTML, CSS, JavaScript, TypeScript, Next.js, GraphQL, React-Query, Redux-toolkit, Webpack, and a vast list of React-related libraries",
